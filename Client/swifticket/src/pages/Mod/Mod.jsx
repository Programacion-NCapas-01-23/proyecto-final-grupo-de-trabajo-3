...
import { assignRole, getAllUsers, removeRole, toggleStatus } from "../../services/User.Services";
...
export default function Mod() {
    ...
    return (
        <div className="flex flex-col h-screen w-screen">
            <div className="px-12 py-6 bg-default-900">
                <div onClick={() => {navigate('/')}} className="flex items-center gap-4 cursor-pointer w-fit">
                    <MdArrowBack className="text-xl" />
                    <p className="text-2xl leading-6 tracking-tighter font-thin"> Go back </p>
                </div>
            </div>
            <div className="flex flex-col sm:flex-row h-[30vh] sm:h-[20vh] w-full justify-between items-start sm:items-end pl-4 sm:pl-8">
                <div className="flex gap-2 justify-center items-center">
                    ...
                    <p className="pl-2 title">Users in Swifticket</p>
                </div>
            </div>
