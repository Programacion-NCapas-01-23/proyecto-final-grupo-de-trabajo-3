  ...
  return currentEvent ? (
    isEdit ? (
      ...
      >
        ...
        <div className="">
          {imageError ? (
            <div className="min-h-[calc(40vh-52px-2rem)] relative bg-cover bg-center bg-[url('/assets/robot.jpg')]">
                  ...
                  return (
                    ...
                    >
                      ...
                      {!soldOut(tier) ? (
                        ...
                        <p className="text-red-600 font-bold leading-6 tracking-tighter w-full sm:text-xl text-center">
                          {' '}
                          SOLD OUT{' '}
                        </p>
                      )}
...
function LinnedText({ text }) {
  return (
    <div className="md:subtitle border-l-2 border-primary pl-default-sm my-default-xs">
      {text}
    </div>
  );
}
...
function soldOut(tier) {
  if (tier.capacity == tier.ticketsSold) return true;
  else return false;
}
