...
export default function UserActions() {
  ...
  return (
    <li className="py-default text-xl">
      <a className="flex items-center md:my-default-xs my-2 cursor-pointer" onClick={redirectToOwnedTickets}>
        <span className="mr-default-xs"> <MdConfirmationNumber size={"2rem"} /> </span>
        My Tickets
      </a>
      <a className="flex items-center md:my-default-xs my-2 cursor-pointer" onClick={redirectToReceiveQR}>
